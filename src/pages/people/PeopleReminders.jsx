...
const premiumStyles = `
    ...
    .p-toolbar { padding: 24px 32px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F0FDF4; background: #F8FAFC; margin-bottom: 24px; }
    ...
    .rem-card-v2 { background: #F8FAFC; border-radius: 24px; padding: 24px; border: 1px solid #F0FDF4; border-left: 6px solid #1B6B3A; display: flex; flex-direction: column; justify-content: space-between; min-height: 200px; transition: all 0.2s; }
    ...
    .rem-person span { font-size: 0.85rem; font-weight: 700; color: #1B6B3A; cursor: pointer; }
    ...
    .status-badge.pending { background: #F0FDF4; color: #1B6B3A; }
    .status-badge.overdue { background: #FEE2E2; color: #DC2626; }
    .status-badge.settled { background: #F0FDF4; color: #64748B; }
