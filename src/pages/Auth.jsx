...
const Auth = () => {
    ...
    const handleOAuthCallback = async (code) => {
        ...
        try {
            ...
            // 2. Perform SSO Login with cliks-be
    ...
    const handleLoginWithBNX = () => {
        ...
        window.location.href = `${BNX_AUTH_URL}/?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&state=${state}`;
    };
                ...
                <div style={{ maxWidth: "400px", width: "100%", textAlign: "center" }}>
                    ...
                    {error && (
                        <div style={{
                            ...
                            borderRadius: '8px', fontSize: '14px', fontWeight: '500', marginBottom: '20px'
                        }}>
                            {error}
                        </div>
                    )}
                    ...
                    <button
                        ...
                        style={{
                            ...
                            cursor: isLoading ? "not-allowed" : "pointer", boxShadow: isLoading ? "none" : "0 8px 25px rgba(27, 107, 58, 0.3)",
                    ...
                    >
                        {isLoading ? (
                            ...
                            <>Login with BNX <ArrowRight size={20} /></>
                        )}
                    </button>
                </div>
            </div>
