...
export const splitExpenseService = {
    ...
    updateSplit: async (id, data) => await apiClient.patch(`/split-expenses/${id}`, data),
    ...
    updateParticipant: async (splitId, participantId, data) => await apiClient.patch(`/split-expenses/${splitId}/participants/${participantId}`, data),
    deleteParticipant: async (splitId, participantId) => await apiClient.delete(`/split-expenses/${splitId}/participants/${participantId}`),
    settleParticipant: async (splitId, participantId) => await apiClient.patch(`/split-expenses/${splitId}/participants/${participantId}/settle`),
};
