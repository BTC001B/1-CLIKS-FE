            ...
            <AnimatePresence>
                {open && (
                    ...
                    >
                        ...
                        {/* Smart Bar with GST, Discount & Labels */}
                        ...
                        {sciMode && (
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '5px', padding: '8px 16px 0 16px', background: '#F8FAFC', borderTop: '1px solid #E2E8F0' }}>
                                {[
                                    ...
                                    { label: '10x', fn: () => { const v = parseFloat(activeInput); setActiveInput(Math.abs(v) < 100 ? String(Math.pow(10, v)) : 'Too Big'); }},
