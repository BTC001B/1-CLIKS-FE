...
const ReferralModal = ({ isOpen, onClose }) => {
    ...
    const [referralCode] = useState('CLIK-PERS-9274Z');
    const referralLink = `https://cliks.beta-softnet.com/join?ref=${referralCode}`;
    ...
    const shareUrl = (platform) => {
        const text = `Join Cliks and simplify your personal finances today! Use my invite link: ${referralLink}`;
        let url = '';
        if (platform === 'twitter') {
