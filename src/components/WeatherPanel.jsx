...
const WeatherPanel = () => {
    ...
    if (isRequestingLocation || (location && (isWeatherLoading || isLocationLoading))) {
        return (
            <div className="flex flex-col h-full w-full bg-white items-center justify-center p-6 text-gray-500">
    ...
    if (geoError) {
        return (
            <div className="flex flex-col h-full w-full bg-white items-center justify-center p-6 text-red-500 text-center">
    ...
    return (
        <div className="flex flex-col h-full w-full bg-gradient-to-b from-blue-50 to-white">
            {/* Header / Location */}
            <div className="flex items-center gap-2 p-5 border-b border-blue-100/50 bg-white/50 backdrop-blur-sm">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                <div className="relative mb-6">
                    <div className="absolute inset-0 blur-2xl opacity-40 bg-blue-400 rounded-full"></div>
                    {isDay ? (
                        <Sun size={80} className="text-amber-400 drop-shadow-md relative z-10" fill="currentColor" />
                    ) : (
                        <Moon size={80} className="text-blue-300 drop-shadow-md relative z-10" fill="currentColor" />
                    )}
                </div>
            ...
            {/* Details Grid */}
            <div className="p-5 grid grid-cols-2 gap-4 bg-white/60 border-t border-blue-100/50">
